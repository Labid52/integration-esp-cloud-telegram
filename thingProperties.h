// Code generated by Arduino IoT Cloud, DO NOT EDIT.
  ...
  #define BOARD_ID "f1f41761-c47a-477f-978c-19562603baf0"
#endif
...
void initProperties() {
 ...
 // ArduinoCloud.addProperty(led, Permission::Write).onUpdate(onLedChange);
  ...
  ArduinoCloud.addProperty(IrState, Permission::Read).publishOnChange(1);
  ArduinoCloud.addProperty(distance, Permission::Read).publishOnChange(1);
  ArduinoCloud.addProperty(throughput, Permission::Read).publishOnChange(1);
  ArduinoCloud.addProperty(rssi, Permission::Read).publishOnChange(1);
  ArduinoCloud.addProperty(rtt_av, Permission::Read).publishOnChange(1);
 ...
 /* ArduinoCloud.addProperty(led, 1, READWRITE, ON_CHANGE, onLedChange);
  ...
  ArduinoCloud.addProperty(IrState, 3, READ, 5 * MINUTES);
#endif
}
